		...
		if filename.endswith('.lrc') and filename not in processed_files:
			with open(os.path.join(subs_path, filename), 'r', encoding='utf-8') as f:
				...
				case_insensitive_replacements = {
					...
					'acg schmuck': 'ACG Schmuck',
					'acgs schmuck': 'ACGS Schmuck',
					'achilles': 'Achilles',
					'adam': 'Adam',
					'adhd': 'ADHD',
					'adidas': 'Adidas',
					...
					'Cream corn 31': 'CreamCorn31',
					'Cream corn': 'CreamCorn',
					'Cream corn': 'CreamCorn',
					...
					'omega lol': 'OMEGALUL',
					'omega lola': 'OMEGALUL',
					'omega lols': 'OMEGALULS',
					'omega long': 'OMEGALUL',
					'omega lost': 'OMEGALUL',
					'omega low': 'OMEGALUL',
					'omega lul': 'OMEGALUL',
					'omega lull': 'OMEGALUL',
					'omega lulled': 'OMEGALULd',
					'omega lulling': 'OMEGALULing',
					'omega lulls': 'OMEGALULS',
					'omega lulz': 'OMEGALULS',
					'omegalo': 'OMEGALUL',
					'omegalol': 'OMEGALUL',
					'omegalos': 'OMEGALULs',
					'omegalul': 'OMEGALUL',
					...
					'rani': 'Ranni',
					'rapidash': 'Rapidash',
					'rat movie mystery of the mayan treasure': 'Rat Movie: Mystery of the Mayan Treasure',
					'rat movie mystery with a Mayan treasure': 'Rat Movie: Mystery with a Mayan Treasure',
					'raticate': 'Raticate',
					'ratmovieorigins': 'Rat Movie: Origins',
					'rattata': 'Rattata',
				    ...
				    'rat movie george lucas special edition': 'Rat Movie: George Lucas Special Edition',
...
if __name__ == '__main__':
	...
	parser.add_argument('--urls', type=str, nargs='+', default=[
		...
		# 'https://youtube.com/playlist?list=PLLZVyAYonIO48AQs35PshGt3AdwCXGjYg',       # Tip of the Hats
