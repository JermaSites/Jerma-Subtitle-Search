    ...
    return {
        ...
        view: () => {
            ...
            [
                ...
                m('button.match-whole-word-toggle', {
                    onclick: () => {
                    ...
                    m('svg.icon#search-icon', { xmlns: 'http://www.w3.org/2000/svg', viewBox: '0 0 20 20', role: 'img', 'aria-label': 'whole word matching icon' }, [
                ...
                m('button.search', { title: 'Search', type: 'submit' }, [
